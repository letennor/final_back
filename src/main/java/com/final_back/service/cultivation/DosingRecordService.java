...
public interface DosingRecordService extends IService<DosingRecord> {
    ...
    List<DosingRecord> getDosingRecordByCondition(Long medicineId, Long batchId, Long dosingPerson, Date startDate, Date endDate, Long recordPerson, String order, Integer isDesc, Integer limit);
}
