...
public interface IncomingRecordService extends IService<IncomingRecord> {
    ...
    List<IncomingRecord> getIncomingRecordByCondition(Long batchId, Date startDate, Date endDate, Integer minAmount, Integer maxAmount, Long goodsId, String order, Integer isDesc, Integer limit);
}
